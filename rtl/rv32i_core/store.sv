...
//Unit consumes 68 LUTs (2 from byte_shift_left, 1 from each write_enable set) and has a 2-LUT propogation delay on result and 1-LUT propogation delay on write_enable.
...
module store(input  logic[31:0] data,
    ...
    //It is difficult to read and I should probably clean it up. However, it synthesizes to 4 LUTs with 1-LUT propogation delay so that's great.
